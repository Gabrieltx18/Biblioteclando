...
namespace TCC
{
    public partial class F_delFuncionarios : Form
    {
        public F_delFuncionarios()
        {
            InitializeComponent();
        }
            ...
            try
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    try
                    {
                        ...
                        string deleteQuery = $"DELETE FROM {tabela} WHERE id_funcionario = @Id";
